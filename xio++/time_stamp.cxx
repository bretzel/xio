...
namespace xio
{
    ...
    time_stamp::time_stamp(time_stamp&& xs)
    {
    ...
    time_stamp::time_stamp(const time_stamp& xs)
    {
        _stamp = xs._stamp;
        _clock = xs._clock;
        _text = xs._text;
    ...
    time_stamp& time_stamp::operator*()
    {
        _text.clear();
    ...
    std::string time_stamp::text(const std::string& a_format_str)
    {
    ...
    time_stamp& time_stamp::operator=(time_stamp&& xs) noexcept
    {
        _stamp = xs._stamp;
        _clock = xs._clock;
        _text = xs._text;
    ...
    time_stamp& time_stamp::operator=(const time_stamp& xs)
    {
        _stamp = xs._stamp;
        _clock = xs._clock;
        _text = xs._text;
